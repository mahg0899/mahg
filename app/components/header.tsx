...
export default function Header() {
    return (
        <div>
            <div className="mx-auto max-w-6/10 mt-6 mb-4 text-main">
                <div className="flex items-center justify-between flex-row">
                    <span className="flex flex-row items-center gap-4">
                        <img src="/mahg_logo.png" alt="#" className="w-10" />
                        <Link href="/" className="text-xl tracking-wider font-bitcount hover:text-btn transition-all duration-300">MAHG</Link>
                    </span>
                    ...
                    <ul className="flex flex-row gap-6 items-center font-semibold text-2xs">
                        <li className="bg-btn rounded-xl px-6 py-2 hover:scale-105 transition-all duration-300 ease-in-out"><a href="#">Contactame</a></li>
